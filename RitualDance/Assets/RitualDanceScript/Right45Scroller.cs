...
public class Right45Scroller : MonoBehaviour
{
    ...
    void Update() 
    {
        ...
        else
        {
            ...
            Vector3 movementDirection = new Vector3(-1f, -1f, 0f).normalized;
            transform.position += movementDirection * beatTempo * Time.deltaTime; ;//move from the ttop-right to the bottom-left_press key D
